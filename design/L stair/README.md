# L stair — exterior stair folded around the SW corner

5916 Panama Ave, Richmond, CA 94804 · APN 510-132-010-8 · Zoning RL2

This is the **L-stair** variant of the addition mockup. Sibling options:
[`../V0/`](../V0/) (straight stair) and [`../spiral_stairs/`](../spiral_stairs/)
(spiral + furniture window). Cost comparison: [`../cost-estimates.md`](../cost-estimates.md).

Code-conforming development of the owner's floorplanner sketches
(`../../sketches/`), positioned against the **actual house plan** from the
